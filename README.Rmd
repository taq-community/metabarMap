...
3. **species_info.csv** - Species metadata
   - Columns: `species`, `English`, `French`, `gbif_url`, `col_link`, `itis_url`, `Native_Quebec`, `Exotic_Quebec`, `status_ca`, `status_qc`, `img`
   ...
   - `status_ca`: Boolean flag indicating species at risk status under Canada's Species at Risk Act (SARA/LEP)
   - `status_qc`: Boolean flag indicating species at risk status under Quebec's Loi sur les espèces menacées ou vulnérables (LEMV)
